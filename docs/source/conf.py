...
# -*- coding: utf-8 -*-
#
# jupyter_locuszoom documentation build configuration file
#
...
_version_py = os.path.join(repo, 'jupyter_locuszoom', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyter_locuszoomdoc'
...
latex_documents = [
    (master_doc, 'jupyter_locuszoom.tex', 'jupyter_locuszoom Documentation',
     'Michał Krassowski', 'manual'),
]
...
man_pages = [
    (master_doc,
    'jupyter_locuszoom',
    'jupyter_locuszoom Documentation',
     [author], 1)
]
